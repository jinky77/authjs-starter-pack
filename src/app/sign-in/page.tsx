...
export default async function SignInPage({ searchParams }: { searchParams: Promise<{ callbackUrl: string | undefined }> }) {
  ...
  return (
    <>
      <div className="flex-col h-screen items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">&ldquo;C'est celui qui dit qui est.&rdquo;</p>
              <footer className="text-sm">Lao Tseu</footer>
            </blockquote>
          </div>
        </div>
        <div className="p-8">
